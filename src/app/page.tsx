...
// Payment handler — calls Netlify Function, redirects to Moyasar
async function handlePayNow(product: typeof products[number]) {
  try {
    ...
    if (data.url) {
      ...
      alert("عذراً، حدث خطأ في معالجة الدفع. حاول مرة أخرى.");
    }
  } catch {
                ...
                <div className="p-5 md:p-6 flex flex-col flex-1">
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-neon-cyan text-black font-bold text-sm hover:bg-neon-cyan/90 active:scale-[0.98] transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)]"
                    >
                      <CardIcon />
                      ادفع الآن
                    </button>
